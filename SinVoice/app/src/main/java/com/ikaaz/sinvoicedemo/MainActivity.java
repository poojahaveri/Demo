package com.ikaaz.sinvoicedemo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
           String[] ll = getAssets().list("sound_effect");
            ...
            LogHelper.d(TAG, "mSoundEffectCount length:" + ll.length);
            LogHelper.d(TAG, "mSoundEffectCount:" + mSoundEffectCount);
        } catch (IOException e1) {
            // TODO Auto-generated catch block
            LogHelper.d(TAG, "No sounds");
            e1.printStackTrace();
        }
            ...
            public void onClick(View arg0) {
                try {
                    ...
                    if (null != strs) {
                        ...
                        mSinVoicePlayer.play(tokens, len, true, 1000, mSoundEffectIndex);
                    } else {
                        mSinVoicePlayer.play(TOKENS, TOKEN_LEN, true, 1000, mSoundEffectIndex);
                    }
